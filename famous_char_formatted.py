...
famous_characters = [
    ...
    "Jesus of Nazareth (5 BC-30) Spiritual teacher and central figure of Christianity.",
    "Buddha (563-483 BC) Spiritual Teacher and founder of Buddhism.",
    "Confucius (551-479 BC)-Chinese philosopher.",
    "St. Paul (5-67)-Christian missionary and one of the main writers of the New Testament.",
    ...
    "Moses (1391-1271 BC) A key figure of Jewish / Christian history gave 10 Commandments of Old Testament",
    "Charles Darwin (1809 - 1882)-cientist who proposed and popularised theory of evolution.",
    ...
    "Constantine the Great (272-337) Roman Emperor who accepted Christian religion.",
    ...
    "Werner Heisenberg (1900-1976) German theoretical physicist-one of the pioneers of Quantum mechanics",
    "Louis Daguerre (1780-1851) French artist and photographer, who is credited with the invention of the camera.",
    ...
    "King Ashoka (260-232 BC) Powerful Indian King who established large empire by conquest before converting to Buddhism and pursuing a peaceful approach",
    ...
    "Lao Tzu (600 BC-) Author of Tao Te Ching and founder of Taoism",
    ...
    "Emperor Wen of Sui (541- 604) Founder of China's Sui Dynasty and reunifying China in 589",
    "Vasco da Gama (1460s-524) Portuguese explorer, first European to reach India and establish a route for imperialism.",
    "Cyrus the Great  (602-530 BC) Founder of the Achaemenid Empire, the first Persian Empire. Relatively enlightened ruler.",
    ...
    "Mencius (38-03BC) Chinese philosopher one of the principal interpreters of Confucianism.",
    "Zoroaster (1200 BC)  Iranian prophet who founded the religion of Zoroastrianism.",
...
#make a list of the stuff in the parenthesis in famous_characters
...
print(new_year_list)
#make a dictionary with new_year_list as the keys and famous_characters as the values
famous_characters_years_dict = {}
for i in range(len(new_year_list)):
    famous_characters_years_dict[famous_characters[i]] =new_year_list[i]
#print(famous_characters_years_dict)
#reorder the dictionary by the numeric value of the keys
famous_characters_years_dict_new = sorted(famous_characters_years_dict, key=lambda i: int(famous_characters_years_dict[i]))
for item in famous_characters_years_dict_new:
    print('"'+item+'",')

# new_year_list.sort(key=int)
# print(new_year_list)
